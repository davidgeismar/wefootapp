...
The premium icon font for [Ionic](http://ionicframework.com/). Designed by [@benjsperry](http://twitter.com/benjsperry).
...
Or install with [component](http://github.com/component/component):
