    ...
    function($ionicTemplateLoader, $ionicBackdrop, $q, $timeout, $rootScope, $document) {
        return {
            ...
            link: function(scope, element, attrs, ngModel) {
                ...
                '<input class="google-place-search" type="search" ng-model="searchQuery" placeholder="Entrer une adresse">',
                '</label>',
                '<button class="button button-clear" style="padding-right: 0px;padding-left: 0px; font-size: 13px;">',
                'Annuler',
                '</button>',
                '</div>',
                    ...
                    scope.$watch('searchQuery', function(query){
                        ...
                        searchEventTimeout = $timeout(function() {
                            ...
                            geocoder.geocode({ componentRestrictions: {
                                country: 'FR'}, address: query}, function(results, status) {
